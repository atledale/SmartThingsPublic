 ...
 */
metadata {
 definition (name: "Aeon Siren (Modded for Dlink DCH-Z510)", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.smoke") {
	capability "Actuator"
	capability "Alarm"
	capability "Switch"
 ...
 tiles(scale: 2) {
    ...
    standardTile("BeepCode", "device.button", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
		state "default", label:'Beep Code', action:"BeepCode", icon:"st.secondary.test"
	}
	standardTile("off", "device.alarm", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
		state "default", label:'Off', action:"alarm.off", icon:"st.secondary.off"
	}
	...
	main "alarm"
	details(["alarm", "FireAlarm", "Ambulance", "PoliceCar", "DoorChime", "BeepCode", "off"])
 }
}
